module github.com/byteintellect/otp_svc
...
require (
	...
	github.com/byteintellect/gorm-opentelemetry v0.0.3 // indirect
	...
	gorm.io/plugin/prometheus v0.0.0-20220414034526-3a4b06c41cbf // indirect
)
